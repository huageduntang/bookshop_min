                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc sorting_asc_disabled">书本名称</th>
                                <th class="sorting_desc sorting_desc_disabled">出版城市</th>
                                <th class="sorting">出版时间</th>
                                <th class="text-center sorting">书本价格</th>
                                <th class="text-center sorting">书本描述</th>
